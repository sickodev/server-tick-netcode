...
export class GameEngine {
   ...
   */
  private render(): void {
    // 1. Retrieve local player predicted coordinates, aim angle, health, and respawn countdown
    ...
    const localRespawnTimeSec = this.predictionEngine.getRespawnTimeRemaining();
